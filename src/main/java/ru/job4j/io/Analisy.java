...
public class Analisy {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(source));
            PrintWriter out = new PrintWriter(new FileOutputStream(target))) {
                ...
                while (line != null) {
                    ...
                    if (("400".equals(lineSplit[0])
                            && !trouble) || ("500".equals(lineSplit[0]) && !trouble)) {
    ...
    public static void main(String[] args) {
        Analisy analisy = new Analisy();
        analisy.unavailable("./server_source.txt",
                "./target.txt");
        analisy.unavailable("./server_source_sec.txt",
                "./target_sec.txt");
